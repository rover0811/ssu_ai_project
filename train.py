...
parser.add_argument('--modeltype', type=str, default="base") # 여기를 base.en -> base로 수정 preprocess기반으로 해야하면 수정
parser.add_argument('--train_json', type=str, default="data/LibriSpeech/train_clean_100.json") # 여기도 json
...
# parser.add_argument('--useGPT', action="store_true") # 그냥 gpt2를 쓰면 이상해짐 한국어 gpt사용해야함
...
options = whisper.DecodingOptions(language="ko", fp16=False, without_timestamps=True) # en -> ko
tokenizer = whisper.tokenizer.get_tokenizer(model.is_multilingual, language="ko") # en -> ko
